...
def test_quickdeck_name_to_url_parses_suffix(monkeypatch):
    import quickdeck
    ...
    class _FakeResponse:
        ...
        def read(self):
            return b'<a href="https://magiccards.info/scans/en/m13/10.jpg">card</a>'

    monkeypatch.setattr(quickdeck.urllib.request, "urlopen", lambda *args, **kwargs: _FakeResponse())

    suffix = quickdeck.name_to_url("Serra Angel")
    assert suffix == "m13/10.jpg"
